    ...
    <div className=''>
      <div className=' flex flex-col gap-10 '>
        ...
        <motion.div className='flex   text-2xl py-10  lg:text-justify justify-center items-center flex-1 bg-shade2/50'
                                   ...
                                   viewport={{ once: true }}>
          <p className='px-10  font-bold'>“ESG as it stands — grounded in disclosures and voluntary market action — will not deliver the necessary change … We must urgently address the tension between profitability and sustainability” – <br /> <span className='text-lg text-shade6 font-normal'>Cambridge University*</span></p>
        </motion.div>
        ...
        <div className='flex-1'>
          <ul className='flex flex-col gap-5 list-disc lg:text-justify hyphens-auto pl-5'>
        ...
        {/* right*/}
        <div className=' flex-1'>
          <ul className='flex flex-col gap-5 list-disc lg:text-justify hyphens-auto pl-5 lg:pl-0'>
