  ...
  return (
    <div>
                ...
                <div className='flex justify-center  my-20 gap-20 '>
                   {/* text*/}
                   <div className='flex-1 text-primary font-raleway space-y-14'>
                       ...
                       <div className='space-y-7'>
                        <h1 className='text-4xl font-bold '>Corporations: </h1>
                       ...
                       {/*Financial Services:*/}
                       <div className='space-y-7'>
                        <h1 className='text-4xl font-bold '>Financial Services: </h1>
                        <ul className='list-disc space-y-3'>
                          <li>
                       ...
                       <div className='space-y-10'>
                        <h1 className='text-4xl font-bold '>Policy and Standards Makers:</h1>
                        <ul className='list-disc space-y-3'>
                          <li>
